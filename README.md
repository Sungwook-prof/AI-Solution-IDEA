...
**금상팀 USB 사용에 대한 조사 결과, 발표자료가 아닌 동영상 자료를 활용한 것으로 결론지음.**

**전체 팀의 코드 부분은 커스터마이징 유무, 데이터셋 유무는 점수를 대체적으로 모두 점수를 주었으며, 일부 0003_EmoNet_ResNet10, open_pose 등의 학습없이 모델 사용한 경우에도 점수를 주었음.**

# 특별 공지 #

**본 대회는 의료AI반도체 전문인력 양성사업에서 지원되는 대회로서, 아이템에 의료적인 데이터나 의료적인 아이디어 반영이나 의료적인 활용방안이 추가되는 경우 <span class="color: red">추가 가점</span>이 가능함.**
- 아이디어에 의료와 관련된 내용이 들어가야 함. 
**창업 캠프는 따로 신청해야 함**
...
# 자료 제출
- 코드 제출 : 11월 1일 밤 12시까지
- 발표자료 제출 : 11월 2일 오전 9시까지
- 시간외 제출은 1시간당 10점 감점
...
- 신분증 사본
- 통장 사본
- 결제 카드가 가족 카드인 경우 가족관계증명서 사본
- 제출처 : fpga@yonsei.ac.kr
- 제출시 제목: [팀명,본인 이름] Colab PRO+ 증빙
- 코랩 관련 비용 입금은 11/4(월), 11/5(화)에 일괄 처리 예정 (하루 15개 처리 가능)
...
|10:10~10:15|개회사|
|10:15~10:20|심사위원 소개|
|10:20~11:45|발표세션1(1~6팀)|
|12:00~13:15|점심|
|13:15~14:45|발표세션2(7~12팀)|
|14:45~14:50|휴식|
|14:50~16:05|발표세션3(13~17팀)|
|16:05~16:30|심사집계 & 만족도조사|
|16:30~16:35|진행 안내|
|16:35~16:45|심사 총평|
|16:45~16:55|수상자 발표 및 시상|
|16:55~17:00|폐회 & 기념촬영|
...
|11:35~11:50|이글스|
|13:15~13:30|포워드|
|13:30~13:45|느그 팀장 남천동 살제|
|13:45~14:00|삭감이|
|14:00~14:15|크로스라인|
|14:15~14:40|BeauLab|
|14:30~14:45|내일은맑음|
|14:50~15:05|심쿵박동|
|15:05~15:20|ProSe(프로세)|
|15:20~15:35|DentAI|
|15:35~15:50|AI의 미래|
|15:50~16:05|코자핑|
...
# 채점 점수 관련
1) 창업 아이디어 평가 : 50점
2) 코드 구현 평가(커스터마이징, OpenVINO 사용, 코드 구현성) : 40점
3) 의료 관련성 : 10점
